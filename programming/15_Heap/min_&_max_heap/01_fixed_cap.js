/* ✅ 1. Min Heap WITH fixed capacity */
class MinHeap{
    constructor(cap){
        this.cap = cap // ✅ 1. Fixed capacity
        this.size = 0
        this.harr = new Array(cap) // ✅ 2. Fixed capacity
    }
    ...
    insertKey(val){
        if(this.size === this.cap) return // ✅ 3. Fixed capacity
...
/* ✅ 2. Max Heap WITH fixed capacity */
class MaxHeap{
    constructor(cap){
        this.cap = cap // ✅ Fixed capacity
        this.size = 0
        this.harr = new Array(cap) // ✅ Fixed capacity
    }
    ...
    insertKey(val){
        if(this.size === this.cap) return // ✅ Fixed capacity
