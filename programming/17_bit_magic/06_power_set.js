// Generate all possible subsets (power set) of a string using bit manipulation
// Power set: Set of all possible subsets including empty set
// For string "abc": [], ["a"], ["b"], ["c"], ["a","b"], ["a","c"], ["b","c"], ["a","b","c"]
...
console.log("=== Power Set Generation using Bit Manipulation ===\n");
powerSet("abc");
